...
#   ifdef NDEBUG
    static const char lib_name[] = "libMoltenVK.dylib";
#   else
    static const char lib_name[] = "libvulkan.1.dylib";
#   endif
...
#else
                    static const char layer_settings_ext[] = "VK_EXT_validation_features";
#endif
